...
class Csr:
            ...
            if ports:
                ...
                for port in ports:
                    ...
                    try:
                        ...
                        self.serial = serial.Serial(self.port_name, baudrate=self.baudrate, timeout=1)
                        print("Successfully connected to UART slave")
                        break
    ...
    def read_csr(self, addr):
        ...
        v = struct.pack('I', 0)
        self.serial.write(v)
        while self.serial.in_waiting < 4: pass
